...
Validator.prototype.validateSchema = function validateSchema (instance, schema, options, ctx) {
  ...
  */
  ...
  if (switchSchema = shouldResolve(schema)) {
    ...
    var switchSchemaValidationErr = this.validateSchema(instance, resolved.subschema, options, subctx);
    if (switchSchemaValidationErr) {
      result.importErrors(switchSchemaValidationErr);
    }
  }
